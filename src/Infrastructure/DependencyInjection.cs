...
using Andead.DockerClient.Infrastructure.Services;
...
namespace Andead.DockerClient.Infrastructure
{
        ...
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            if (configuration.GetValue<bool>("UseInMemoryDatabase"))
            {
                services.AddDbContext<ApplicationDbContext>(options =>
                    options.UseInMemoryDatabase("Andead.DockerClientDb"));
            }
            else
            {
                services.AddDbContext<ApplicationDbContext>(options =>
            ...
            services.AddHttpClient<Suppliers.Docker.DockerClient>()
                .ConfigurePrimaryHttpMessageHandler(() => new DockerHttpClientHandler(configuration));
